...
public interface IOrderService {
     ...
     */
    Page<OrderForListResponseDTO> findAll(Pageable pageable);
    ...
    /**
     * Obtiene las órdenes del mesero autenticado paginadas.
     */
    Page<OrderForListResponseDTO> findMyOrders(Pageable pageable);
    ...
    /**
     * Obtiene las órdenes del mesero autenticado filtradas por rango de fechas con
     * paginación.
     */
    Page<OrderForListResponseDTO> findMyOrdersByDateRange(LocalDateTime startDate, LocalDateTime endDate,
            Pageable pageable);
    ...
    /**
     * Obtiene órdenes filtradas por rango de fechas con paginación.
     */
    Page<OrderForListResponseDTO> findByDateRange(LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);
    ...
    /**
     * Obtiene las órdenes asignadas al mesero autenticado que están en estado
     * ASSIGNED.
     ...
     * Una orden puede facturarse SOLO si está en estado DELIVERED y no ha sido
     * facturada.
     *
     ...
     * IMPORTANTE: Este método solo debe llamarse después de guardar la factura
     * exitosamente.
     *
